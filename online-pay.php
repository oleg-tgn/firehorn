...
<div class="wrapper">
    ...
    <section class="container">
        ...
        <h2 class="title" id="start">
            <span style="font-size:20px; display: block;">Оплата стартового взноса</span>
        </h2>
        <nav aria-label="breadcrumb" class="col-12 col-md-8 col-lg-5" style="margin: 0 auto">
            <ol class="breadcrumb breadcrumb-online">
                <li class="breadcrumb-item"><a href="/online.php">Шаг 1. Регистрация</a></li>
        ...
        <form method="POST" action="https://money.yandex.ru/quickpay/confirm.xml"  class="registration-form  col-12 col-md-5" style="margin: 0 auto;">        
            ...
            <input type="hidden" name="formcomment" value="Fire Horn League Online 24 февраля">
            <input type="hidden" name="short-dest" value="Fire Horn League Online 24 февраля">
            ...
            <input type="hidden" name="successURL" value="https://fire-horn.ru/online-final.php?team=<?=$team?>">
