...
<head>
    ...
    <title>Турнирная сетка | <?php include './include/title.php'; ?></title>
    <?php
...
<div class="wrapper">
    ...
    <section class="container">
        <h1 class="title" style="margin-bottom: 0; font-size:36px;">
            #8 Онлайн РТК (5x5)<br> 
            <span class="main-title__date" style="font-weight: normal;">25 июля 2020</span>
        </h1>
    ...
    <div style="margin-top: 50px;">
            <iframe src="https://challonge.com/ru/1qmtdb84/module" width="100%" height="650" frameborder="0" scrolling="auto" allowtransparency="true"></iframe>
    </div>
